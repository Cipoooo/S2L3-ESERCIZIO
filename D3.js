...
*/
/*const myArray = starWarsCharacters.names
...
if(crewmass<500){
  console.log("The ship is under load")
}else if (crewmass>500 && 699){
  console.log("Ship is half loaded");
}else if (crewmass<900 && crewmass>700){
  console.log("Warning: ship load is over 700")
...
for(let i= starWarsCharacters.gender; i < starWarsCharacters; i++ ){
  gender= starWarsCharacters.gender[i];
